...
# Django settings for duck_rip project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Tomasz Ducin', 'tomasz.ducin [at] gmail.com'),
)
...
SECRET_KEY = 'xn%w&$_eyi=jgjqb*f+=j-91@4d3q=&facn=$q3z=_z5w*ls@i'
...
WSGI_APPLICATION = 'duck_rip.wsgi.application'
